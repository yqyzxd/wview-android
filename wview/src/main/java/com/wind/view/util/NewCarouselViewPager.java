...
import com.wind.view.FixedSpeedScroller;
import com.wind.view.R;
import com.wind.view.WidthRatioFrameLayout;
...
public class NewCarouselViewPager extends LinearLayout implements ViewPager.OnPageChangeListener {
    public NewCarouselViewPager(@NonNull Context context) {
        super(context);
        init(null);
    }

    public NewCarouselViewPager(@NonNull Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
        init(attrs);
    }

    public NewCarouselViewPager(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init(attrs);
    }

    @TargetApi(Build.VERSION_CODES.LOLLIPOP)
    public NewCarouselViewPager(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr, @StyleRes int defStyleRes) {
    ...
    private NewCarouselViewPager.ImagePagerAdapter mImagePagerAdapter;
    private RecyclerView mRvDots;
    private int mCurrentPosition;
    private NewCarouselViewPager.DotsAdapter mDotsAdapter;
    private NewCarouselViewPager.CarouselHandler mHander;
    ...
    private void init(AttributeSet attrs) {
        ...
        if (mDotGravity == DOT_GRAVITY_BELOW) {
            ...
            layoutId = R.layout.wd_layout_carousel;
        }
        inflate(getContext(), layoutId, this);
        mRfl = findViewById(R.id.rfl);
        ...
        mDotsAdapter = new NewCarouselViewPager.DotsAdapter();
...
//        startCarousel();
    ...
    private void setupPager(List resIds) {
        ...
        mImagePagerAdapter = new NewCarouselViewPager.ImagePagerAdapter(getContext(), resIds);
    ...
    public void startCarousel(int interval, boolean showDots) {
        cancel();
        mInterval = interval;
        mHander = new NewCarouselViewPager.CarouselHandler(getContext(), mSize);
        //启动轮播
        mHander.sendEmptyMessageDelayed(NewCarouselViewPager.CarouselHandler.MSG_UPDATE_IMAGE, mInterval);
        if (!showDots) {
    ...
    public void cancel() {
        if (mHander != null) {
            mHander.removeMessages(NewCarouselViewPager.CarouselHandler.MSG_UPDATE_IMAGE);
            mHander = null;
        }
    }
    ...
    public void onPageSelected(int position) {
        ...
        mHander.sendMessage(Message.obtain(mHander, NewCarouselViewPager.CarouselHandler.MSG_PAGE_CHANGED, position, 0));
    }
    ...
    public void onPageScrollStateChanged(int state) {
        ...
        switch (state) {
            case ViewPager.SCROLL_STATE_DRAGGING:
                mHander.sendEmptyMessage(NewCarouselViewPager.CarouselHandler.MSG_KEEP_SILENT);
                break;
    ...
    private class DotsAdapter extends RecyclerView.Adapter<NewCarouselViewPager.DotsAdapter.ViewHolder> {
        ...
        @Override
        public NewCarouselViewPager.DotsAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
            return new NewCarouselViewPager.DotsAdapter.ViewHolder(LayoutInflater.from(getContext()).inflate(R.layout.wd_carousel_item_dot, parent, false));
        }

        @Override
        public void onBindViewHolder(NewCarouselViewPager.DotsAdapter.ViewHolder holder, int position) {
